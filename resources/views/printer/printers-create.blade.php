        ...
        <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
            ...
            <div class="card-header bg-gradient-primary py-4 text-white"
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="fw-bold mb-1"><i
                            class="bi bi-printer-fill me-2"></i>{{ isset($printer) ? 'Edit Printers' : 'Add New Printers' }}
                    </h3>
                ...
                <form method="POST"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" name="model"
                                        ...
                                        placeholder="Enter a model" value="{{ old('model', $printer->model ?? '') }}">
                                </div>
                                @error('model')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                    ...
                    <div class="d-flex justify-content-end align-items-center border-top pt-4 mt-2">
                        ...
                        <a href="{{ route('printers.index') }}" class="btn px-4 shadow-sm text-white"
                            style="background-color: #1A3645;margin-left:20px;">
